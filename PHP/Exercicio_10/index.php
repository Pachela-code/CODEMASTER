...
<body>
  ...
  <?php if ($form) : ?>
    <div>
      <p>Temperatura em graus Celsius: <?= $temp ?></p>
      <p>Temperatura em graus Fahrenheit: <?= $temperature_f_formatted ?></p>
      <p>Temperatura em graus Kelvin: <?= $temperature_k_formatted ?></p>
